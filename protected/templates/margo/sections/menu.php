...
<ul class="nav navbar-nav navbar-right">
    <li>
        <a <?php echo (in_array($this->route->is(), ['/', 'index1', 'index2', 'index3', 'index4', 'index5', 'index6', 'index7'])) ? 'class="active"' : '' ?>
            href="<?php $url->to('') ?>">Home</a>
        <ul class="dropdown">
            <li><a <?php echo ($this->route->is() == '/') ? 'class="active"' : '' ?> href="<?php $url->to('') ?>">Home
                    Main Version</a>
            </li>
            <li><a <?php echo ($this->route->is() == '/') ? 'class="active"' : '' ?> href="<?php $url->to('') ?>">Home
                    Version 1</a>
            </li>
            <li><a <?php echo ($this->route->is() == 'index2') ? 'class="active"' : '' ?>
                    href="<?php $url->to('index2') ?>">Home Version 2</a>
            </li>
            <li><a <?php echo ($this->route->is() == 'index3') ? 'class="active"' : '' ?>
                    href="<?php $url->to('index3') ?>">Home Version 3</a>
            </li>
            <li><a <?php echo ($this->route->is() == 'index4') ? 'class="active"' : '' ?>
                    href="<?php $url->to('index4') ?>">Home Version 4</a>
            </li>
            <li><a <?php echo ($this->route->is() == 'index5') ? 'class="active"' : '' ?>
                    href="<?php $url->to('index5') ?>">Home Version 5</a>
            </li>
            <li><a <?php echo ($this->route->is() == 'index6') ? 'class="active"' : '' ?>
                    href="<?php $url->to('index6') ?>">Home Version 6</a>
            </li>
            <li><a <?php echo ($this->route->is() == 'index7') ? 'class="active"' : '' ?>
                    href="<?php $url->to('index7') ?>">Home Version 7</a>
            </li>
        </ul>
    </li>
    <li>
