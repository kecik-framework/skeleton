...
<head>
    ...
    <?php if ($this->request->get('p') == ''): ?>
        <link href="<?php echo $this->url->baseUrl() ?>assets/adminlte/js/iCheck/flat/blue.css" rel="stylesheet"
              type="text/css"/>
    <?php endif ?>
    <!-- Morris chart -->
...
<body
    class="skin-blue <?php echo (!empty($this->request->get('layout'))) ? str_replace('_', ' ', $this->request->get('layout')) : '' ?>">
<div class="wrapper">
