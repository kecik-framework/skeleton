...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="<?php $url->to('mailbox'); ?>?p=mailbox" class="btn btn-primary btn-block margin-bottom">Back
                    to Inbox</a>
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="<?php $url->to('mailbox'); ?>?p=mailbox"><i class="fa fa-inbox"></i> Inbox
                ...
                <div class="box box-primary">
                    ...
                    <textarea id="compose-textarea" class="form-control" style="height: 300px">
                      ...
                      <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain
                          ...
                          pain that produces no resultant pleasure? On the other hand, we denounce with righteous
                          indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of
                          the moment, so blinded by desire, that they cannot foresee</p>
                      <ul>
                          <li>List item one</li>
                          <li>List item two</li>
