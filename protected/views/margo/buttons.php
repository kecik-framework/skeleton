        ...
        <div class="row sidebar-page">
            ...
            <div class="col-md-9 page-content">
                ...
                <p>
                    ...
                    <a href="#" class="btn-system btn-medium border-btn btn-gray"><i class="icon-heart-4"></i>
                        Button</a>
                ...
                <p>
                    ...
                    <a href="#" class="btn-system btn-large border-btn btn-black"><i class="icon-heart-4"></i>
                        Button</a>
                    <a href="#" class="btn-system btn-medium border-btn btn-black"><i class="icon-heart-4"></i>
                        Button</a>
                    <a href="#" class="btn-system btn-small border-btn btn-black"><i class="icon-heart-4"></i>
                        Button</a>
