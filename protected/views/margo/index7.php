...
<div id="content" class="full-sections">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 service-box service-icon-left">
                    ...
                    <div class="service-content">
                        ...
                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut <strong class="accent-color">odit
                                aut</strong> fugit, sed quia dolores.</p>
                    </div>
                </div>
                <!-- End Service Icon 1 -->
    ...
    <div class="section"
         style="padding-top:60px; padding-bottom:60px; border-top:1px solid #eee; border-bottom:1px solid #eee; background:#f9f9f9;">
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Vimeo Iframe -->
                <div class="col-md-6">
                    <iframe src="https://player.vimeo.com/video/63322694?title=0&amp;byline=0&amp;portrait=0"
    ...
    <div class="section" style="padding-top:60px; padding-bottom:60px; border-top:0; border-bottom:0; background:#fff;">
        <div class="container">
            ...
            <!-- Button in Center -->
            <p class="text-center"><a href="#" class="btn-system btn-medium border-btn"><i class="icon-brush"></i> View
                    Full Portfolio</a></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has to
                        ...
                        cent, but also the leap into electronic typesetting, remaining essentially unchanged. It was
                        popular in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, more
