...
<div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
    ...
    <p class="text-center">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
        ...
        <br/>veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas
    ...
    <div class="container">
        ...
        <p class="text-center">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium <span
            ...
            <br/>veritatis et quasi <span class="accent-color sh-tooltip" data-placement="bottom"
                                          title="Simple Tooltip">architecto</span> beatae vitae dicta sunt explicabo.
...
<div id="parallax-one" class="parallax"
     style="background-image:url(<?php echo $assets->images('parallax/bg-02.jpg') ?>);">
