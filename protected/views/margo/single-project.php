        ...
        <div class="project-page row">
            ...
            <div class="project-media col-md-8">
                <div class="touch-slider project-slider">
                    <div class="item">
                        <a class="lightbox" title="This is an image title" href="images/Portfolio-1/1.png"
                    ...
                    <div class="item">
                        <a class="lightbox" title="This is an image title" href="images/Portfolio-1/4.png"
                           data-lightbox-gallery="gallery2">
                            <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                    ...
                    <div class="item">
                        <a class="lightbox" title="This is an image title" href="images/Portfolio-1/12.png"
                           data-lightbox-gallery="gallery2">
                            <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
            ...
            <div class="project-content col-md-4">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sed facilisis purus. Donec interdum
                    massa at ipsum vehicula tristique. Maecenas bibendum dictum tincidunt. Sed nec justo ac libero
                    consequat tincidunt. Cras eget molestie justo.</p>
            ...
            <div class="projects-carousel touch-carousel">
                    ...
                    <div class="portfolio-border">
                        <div class="portfolio-thumb">
                            <a class="lightbox" title="This is an image title"
                               href="<?php echo $assets->images('portfolio-big-01.jpg') ?>">
                                <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                ...
                <div class="portfolio-item item">
                    <div class="portfolio-border">
                        <div class="portfolio-thumb">
                            <a class="lightbox" title="This is an image title"
                               href="<?php echo $assets->images('portfolio-big-02.jpg') ?>">
                                <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                ...
                <div class="portfolio-item item">
                    <div class="portfolio-border">
                        <div class="portfolio-thumb">
                            <a class="lightbox" title="This is an image title"
                               href="<?php echo $assets->images('portfolio-big-03.jpg') ?>">
                                <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
