                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $assets->images('user3-128x128.jpg') ?>" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $assets->images('user4-128x128.jpg') ?>" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php $url->to(''); ?>?layout=sidebar-collapse_fixed"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
              </ul>
            </li>
            <li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php $url->to('charts-inline'); ?>?p=charts"><i class="fa fa-circle-o"></i> Inline charts</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php $url->to('ui-timeline'); ?>?p=ui-timeline"><i class="fa fa-circle-o"></i> Timeline</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php $url->to('forms-general'); ?>?p=forms-general"><i class="fa fa-circle-o"></i> General Elements</a></li>
                <li><a href="<?php $url->to('forms-advanced'); ?>?p=forms-advanced"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
                <li><a href="<?php $url->to('forms-editors'); ?>?p=forms-editors"><i class="fa fa-circle-o"></i> Editors</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php $url->to('tables-simple'); ?>?p=tables-simple"><i class="fa fa-circle-o"></i> Simple tables</a></li>
                <li><a href="<?php $url->to('tables-data'); ?>?p=tables-data"><i class="fa fa-circle-o"></i> Data tables</a></li>
              </ul>
            </li>
            <li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php $url->to('example-invoices'); ?>?p=invoices"><i class="fa fa-circle-o"></i> Invoice</a></li>
                <li><a href="<?php $url->to('example-login'); ?>?p=login"><i class="fa fa-circle-o"></i> Login</a></li>
                <li><a href="<?php $url->to('example-register'); ?>?p=register"><i class="fa fa-circle-o"></i> Register</a></li>
                <li><a href="<?php $url->to('example-lockscreen'); ?>?p=lockscreen"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
